...
SUMMARY_FIELDS = [
    ...
    "stretch_max_mean",
    "stretch_max_area_weighted_mean",
    "stretch_max_p95",
    "stretch_max_max",
    "condition_number_mean",
    "condition_number_area_weighted_mean",
...
def build_run_summary(method: str, iters: int, metrics_payload: dict) -> dict:
    ...
    return {
        ...
        "stretch_max_mean": _optional_float(final["distortion"], "stretch_max_mean"),
        "stretch_max_area_weighted_mean": _optional_float(final["distortion"], "stretch_max_area_weighted_mean"),
        "stretch_max_p95": _optional_float(final["distortion"], "stretch_max_p95"),
        "stretch_max_max": _optional_float(final["distortion"], "stretch_max_max"),
        "condition_number_mean": _optional_float(final["distortion"], "condition_number_mean"),
        "condition_number_area_weighted_mean": _optional_float(final["distortion"], "condition_number_area_weighted_mean"),
        "condition_number_p95": _optional_float(final["distortion"], "condition_number_p95"),
